package com.springboottemplate.redis.aop;
...
import com.springboottemplate.redis.annotation.QueryCacheKey;
...
public class RedisCacheAspect {
	 ...
	 */
	@Pointcut("@annotation(com.springboottemplate.redis.annotation.QueryCache)")
	 ...
	 * 也可以使用切面表达式execution(* com.springboottemplate.redis.*..*(..)) 切和更新数据相关的方法
	 */
	@Pointcut("@annotation(com.springboottemplate.redis.annotation.DeleteCache)")
